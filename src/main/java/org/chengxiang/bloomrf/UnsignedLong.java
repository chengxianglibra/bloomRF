...
/**
 * Copied from guava with some extension.
 *
 ...
 * <p>
 * Copy from Guava and extend to bit shift operations.
 */
public final class UnsignedLong extends Number implements Comparable<UnsignedLong>, Serializable {
  ...
  /**
   * Returns this bit shift to left.
   */
  public UnsignedLong bitShiftLeft(int bits) {
    return fromLongBits(value << bits);
  }

  /**
   * Returns this bit shift to right, fulfill 0 to new bit.
   */
  public UnsignedLong bitShiftRight(int bits) {
    return fromLongBits(value >>> bits);
  }
   ...
   * Returns this & other.
   */
  public UnsignedLong bitAnd(UnsignedLong other) {
    return fromLongBits(value & other.value);
  }

  /**
   * Returns bit prefix length of this and other.
   */
  public int samePrefixLength(UnsignedLong other) {
    long first = value;
    long second = other.value;
    for (int i = 1; i <= 64; i++) {
      if (first >> i == second >> i) {
        return 64 - i;
      }
